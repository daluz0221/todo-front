                    ...
                    <tbody className="divide-y divide-gray-200">
                        {
                            products.map(product => (
                                <tr key={product.id} className="flex flex-col md:table-row mb-4 md:mb-0 border-b md:border-b-0 border-gray-700 md:border-none p-2 md:p-0">
                                    <td className="md:hidden px-3 py-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex space-x-1 -mt-1 -mr-1">
                                                <button className="text-indigo-500 hover:text-indigo-300"><Edit size={16} /> </button>
                                                <button className="text-red-500 hover:text-red-300"><Trash2 size={16} /> </button>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-2 text-xs text-gray-300">
                                            ...
                                            </div>
                                            {
                                                [
                                                    ...
                                                    <div key={field}> 
                                                        <span className="capitalize">{field}: {product[field as keyof Product]} </span>
                                                    </div>
                                                ))
                                            }
                                        </div>
...

                                    {
                                        [
                                            ...
                                            <td key={field} className="hidden md:table-cell  px-6 py-4 whitespace-nowrap text-sm text-gray-300"> 
                                                {field === "price" ? `${product[field].toFixed(2)}` : product[field as keyof Product]}
                                            </td>
                                        ))
                                    }
